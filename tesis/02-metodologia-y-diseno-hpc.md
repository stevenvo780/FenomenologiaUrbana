...
- **C3 — Habitabilidad declarada negativa.** Se cumple si las transcripciones de entrevistas codifican mayoritariamente `EVITABLE`, `NO_DESEABLE` o `DIFICIL_DE_VIVIR` por encima de `HABITABLE`/`DESEABLE` en esa franja.
